...
actual class HealthService(private val context: Context) {
    ...
    private var _isPermissionSheetVisible by mutableStateOf(false)

    actual val isPermissionSheetVisible: Boolean
        get() = _isPermissionSheetVisible

    actual fun showPermissionSheet() {
        _isPermissionSheetVisible = true
    }

    actual fun hidePermissionSheet() {
        _isPermissionSheetVisible = false
    }
